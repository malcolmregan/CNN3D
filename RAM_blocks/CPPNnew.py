...
def get_fitness(g, inp, CLASS, k):
    ...
    save_path=str(os.path.dirname(os.path.realpath(__file__)))+'/CPPNGenerated/{0}/moreefficient2/class{1}'.format(MODEL, CLASS)
